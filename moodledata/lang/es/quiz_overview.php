...
$string['regrade_attempts'] = 'Recalculando intentos...';
...
$string['regrade_regradeneedednotificationmessage'] = 'El último simulacro de calificación encontrado que modificaría las calificaciones de  {$a->questions} preguntas en {$a->attempts}';
$string['regrade_regradenow'] = 'Recalcular ahora';
